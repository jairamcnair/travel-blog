    ...
    constructor() {
        ...
        template.innerHTML = `
            <style>
                ...
                .footer-container{position: absolute; bottom:0; border-top: 1px solid #c2c2c2ff; width: 100%; display: flex; flex-direction: column; align-items: center; padding: 40px 0px 10px 0px; background-color: #f7f7f7ff; border-bottom: 1px solid #c2c2c2ff;}
